...
from .models import FMCG,FB,Jewellery,Banner_video,Contact,Jewelegance
...
class  AdminJewelegance(admin.ModelAdmin):
    list_display=('Id','Title','Image')
...
admin.site.register(Jewelegance,AdminJewelegance)
